...
【写作上下文】
Chapter mission: 星相仪初鸣
Objective: 周衍在废药炉区意外触发残缺铜盘，让星相仪第一次苏醒照出阵纹裂点与矿脉薄弱处，从中尝到'算得比别人早一步'的甜头，并决定拿这件残器去赌一次更大的资源回报。
Expectation: 周衍在废药炉里摸出一枚残缺铜盘，本以为只是块烂法器，谁知铜盘忽然短鸣，为他照出矿脉裂点与阵纹薄弱处；这件后来被称作浑天星相仪的残器，让他第一次尝到“算得比别人早一步”能换来什么。
Task sheet:
开场：让周衍因暗账线索摸进废炉区。中段：写星相仪短暂苏醒，清楚展示它能看见裂点却不能直接给答案。结尾：让周衍决定拿这件残器去赌一次更大的资源回报。
Plan role: setup
Target length: around 5840 Chinese characters (target range 4964-6716; start wrapping near 6416, never exceed 7016, and do not end clearly below the minimum).
Must advance
- 承接上章末尾的玄铁悬念与三天期限第二天的压力
- 周衍在废药炉区发现残缺铜盘并触发第一次苏醒
- 星相仪明确展示'能照出裂点却不能直接给答案'的能力边界
- 周衍用星相仪照出第一个可用信息（阵纹薄弱处或矿脉裂点）
- 周衍决定拿这件残器去赌更大回报
Must preserve
- 周衍怀里仍揣着玄铁，三天期限的紧迫感不消失
- 周阿禾病情的三天生死线作为暗线压力
- 周衍的冷硬求生心态，不做作的利己逻辑
- 底层资源匮乏的真实感，每一步都要付代价
- 星相仪是残器、有局限，不是一启动就全知全能
Risk notes
- 最易失焦：把星相仪写成'给答案的金手指'，破坏底层逆袭逻辑
- 最易变平：功能展示过于直白，读者一眼望到头
- 最易跑偏：忽略与上章玄铁、十天期限的衔接，破坏连续性
- 必须避免：让周衍快速掌握用法，要有代价和试探过程
Ending guidance: 铜盘在周衍手中银光大盛，但光里浮现的不是宝藏坐标，而是一道他看不懂的纹路——这东西到底是什么？它为什么偏偏在他手里醒过来？
...
Previous chapter: 第2章《断炊山谷》
Previous summary: Plot: 周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片；这些数字不值一百文，但值一条命 Character: 他站起来，把阿禾的被子往上拉了拉，然后走到门边，推开门，走进新一天的灰蒙蒙的光里
Last Scene: 新一天的灰蒙蒙的光里
...
Reference Sentences
- 这些数字不值一百文，但值一条命。
- 他站起来，把阿禾的被子往上拉了拉，然后走到门边，推开门，走进新一天的灰蒙蒙的光里。
- 该去找宁见微了。
Carry over facts
- 这些数字不值一百文
- 但值一条命
...
- 然后走到门边
- 推开门
Opening directive: 本章开头必须先接住第2章结尾的最后动作、地点、决策或风险，再展开新内容。除非任务单明确要求跳时或换场，否则禁止直接切到无关新场景；如确需切换，第一段必须写出过桥。
...
Plot: 周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片；这些数字不值一百文，但值一条命 Character: 昨天他拒绝了石问渠八十文的开价，因为不够；他站起来，把阿禾的被子往上拉了拉，然后走到门边，推开门，走进新一天的灰蒙蒙的光里
cmo58ucj900dmbf8o4bgtdba5: goal=活下去并抓住第一批真正能改变命运的资源 | emotion=周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片 | 周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片；周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片；卷前期处于底层求生态
cmo58ucj900dnbf8o09llmxsb: goal=先活下来，再把星相仪和自己的命数重新握回手里 | emotion=重伤被困下界 | 重伤被困下界
cmo58ucj900dobf8oe3uokjy8: goal=活到哥哥不必再为一株草拿命去赌的时候 | emotion=靠药吊命 | 靠药吊命
周衍把竹篓里的净身泥倒进背后的麻袋，又弯腰去摸下一块布片 (known)
那块玄铁还在怀里，硬邦邦地硌着肋骨 (known)
