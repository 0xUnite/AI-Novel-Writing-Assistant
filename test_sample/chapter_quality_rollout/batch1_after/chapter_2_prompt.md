...
【写作上下文】
Chapter mission: 断炊山谷
Objective: 把周衍从被动求生逼入主动算计的新阶段，让他意识到想活下去不能只靠吃苦，还得有一本别人看不见的暗账；完成外门断粮→药童转卖→抽签入死班→被迫铤而走险的压迫升级，同时让他在矿口偷记到第一份可用数据。
Expectation: 外门断粮后，药谷把一批药童转卖去黑矿抵账，周衍为了不被编进必死的深井班，只能冒险替人做假账、偷记矿监的出入数目；他第一次明白，想活下去不能只会吃苦，还得先有一本别人看不见的暗账。
Task sheet:
开场：用断粮、抽签和转卖黑矿把局势一下压紧。中段：让周衍在躲死班和记暗账之间做险招，具体拿到第一份可用数据。结尾：留下黑矿里一定藏着更大脏账的信号，把他逼去更深处。
Plan role: setup
Target length: around 5720 Chinese characters (target range 4862-6578; start wrapping near 6278, never exceed 6878, and do not end clearly below the minimum).
Must advance
- 外门断粮导致药童被转卖黑矿的完整因果链
- 抽签确定周衍入深井班名单的压迫瞬间
- 石问渠提出以暗账换活路的险招
...
- 第一份暗账数据暴露黑矿脏账规模
Must preserve
- 周衍的核心特质：冷硬、算计、耐性，不主动冒险但被迫时敢下险注
- 石问渠的灰色导师定位：给路指方向但不给兜底
- 阿禾的病情线作为情感锚点不断牵动周衍
- 宁见微的灰盟友关系：给三天期限、今日第二天
- 季寒庐的反派威胁：把持矿路、已知周衍有图谋
Risk notes
- 不能跳过玄铁变现与断粮压迫之间的因果衔接，两件事必须形成递进而非断裂
- 周衍从被动求生到主动算计的转折必须有内心弧线，不能写成突然开窍
- 第一份暗账数据必须具体可写（具体数字、具体漏洞），不能只是概念性提及
- 石问渠的指点要保持黑市老手的灰色调，不能写成正面导师
- 阿禾的病情线必须与周衍的冒险形成情感张力，不能沦为背景板
Ending guidance: 周衍从矿口出来，手里终于有了第一份暗账数据。他以为这是保命的筹码，却不知道黑矿深处的账本比他能看见的大十倍、百倍。那份更大的脏账正等着他一步步走进去。
...
Previous chapter: 第1章《药童不值钱》
Previous summary: Plot: 灰蒙蒙的天压在药谷上方，像一块永远晒不干的破布；至于那块玄铁最终会落到谁手里—— Character: 他挖到了不该挖的东西，也被人看见了不该看见的东西；他要先想清楚，谁才是真正的买家
...
- 他要先想清楚
- 谁才是真正的买家
Opening directive: 本章开头必须先接住第1章结尾的最后动作、地点、决策或风险，再展开新内容。除非任务单明确要求跳时或换场，否则禁止直接切到无关新场景；如确需切换，第一段必须写出过桥。
...
Plot: 灰蒙蒙的天压在药谷上方，像一块永远晒不干的破布；至于那块玄铁最终会落到谁手里—— Character: 动作不快不慢，尸水的寒气顺着布片渗进指骨，他连眉头都没皱一下；他要先想清楚，谁才是真正的买家
cmo58ucj900dmbf8o4bgtdba5: goal=活下去并抓住第一批真正能改变命运的资源 | emotion=周衍蹲在尸坑边沿，指尖捏住一块沾满尸水的布片，抖了抖，让上面的残药顺着布纹滴进手边的竹篓里 | 周衍蹲在尸坑边沿，指尖捏住一块沾满尸水的布片，抖了抖，让上面的残药顺着布纹滴进手边的竹篓里；周衍蹲在尸坑边沿，指尖捏住一块沾满尸水的布片，抖了抖，让上面的残药顺着布纹滴进手边的竹篓里；卷前期处于底层求生态
cmo58ucj900dnbf8o09llmxsb: goal=先活下来，再把星相仪和自己的命数重新握回手里 | emotion=重伤被困下界 | 重伤被困下界
cmo58ucj900dobf8oe3uokjy8: goal=活到哥哥不必再为一株草拿命去赌的时候 | emotion=靠药吊命 | 他收回手，在床边的破木墩上坐下，沉默地看着周阿禾；靠药吊命
灰蒙蒙的天压在药谷上方，像一块永远晒不干的破布 (known)
周衍蹲在尸坑边沿，指尖捏住一块沾满尸水的布片，抖了抖，让上面的残药顺着布纹滴进手边的竹篓里 (known)
