...
const routes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: "short-stories", element: <NovelList contentForm="short_story" /> },
      { path: "short-stories/create", element: <NovelCreate contentForm="short_story" /> },
      { path: "short-stories/:id/edit", element: <NovelEdit /> },
      { path: "short-stories/:id/chapters/:chapterId", element: <NovelChapterEdit /> },
